...
(function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    /* La fenêtre d'aperçu défile en interne : on la rend accessible au clavier
       (focusable + rôle + étiquette) pour que le contenu tenu dans le cadre
    ...
    if (preview) {
      ...
      preview.setAttribute("aria-label",
        "Aperçu du site composé — faites défiler pour voir la suite");
    }
  });
})();
