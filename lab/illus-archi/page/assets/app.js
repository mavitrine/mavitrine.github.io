...
(function () {
  ...
  /* Illustrations — système SVG local, nourri aux jetons (voir illustrations.js,
     chargé avant ce fichier). Repli défensif si le module manque. */
  var ILLUS = window.MV_ILLUS || {
    motif: function () { return ""; },
    storefront: function () { return ""; },
  ...
  function renderSection(sec) {
    ...
    if (sec.type === "liste") {
      ...
      sec.items.forEach(function (p, idx) {
        ...
        var avatar = el("div", "pv-avatar");
        avatar.innerHTML = ILLUS.avatar(idx);
  ...
  function renderPreview() {
    ...
    var shot = el("div", "pv-shot");
    shot.innerHTML = ILLUS.storefront(cat.id);
